...
namespace FFRPG.Modules
{
    public class PlayerList
    {
        ...
        private void AddParty()
        {
            if (MainWindow.Config.ChatChannel == "/p" && MainWindow.Config.AutoParty)
            {
                if (MainWindow.Game != null && Players != null)
                {
                    ...
                    if (FFRPG.ClientState.LocalPlayer != null)
                    {
                        PlayerManager.UpdateParty(ref Players, FFRPG.ClientState.LocalPlayer.Name.TextValue, MainWindow.Config.AutoNameMode);
                    }
                }
            }
        }
        ...
        {
            var target = FFRPG.ClientState.LocalPlayer.TargetObject;
        ...
        {
            if (string.IsNullOrEmpty(Dealer.Name) && FFRPG.ClientState != null)
            {
                Dealer.Name = FFRPG.ClientState.LocalPlayer.Name.TextValue;
